...
public class LauDB 
{
    ...
    /**
        ...
        * file: Caminho do arquivo de banco de dados a ser aberto
        * @param file
        */
    ...
    private String Row(int row, int table) 
    {
        ...
        catch (Exception e) { /* erro de limite */ }
        return tmp;
    }

    /**
        * Retorna o objeto resgatado pelo prox() <br>
        * É aconselhável que só se use esse método quando for implementa-lo em loop
        * while
        * @return 
        */
