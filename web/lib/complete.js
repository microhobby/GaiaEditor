...
(function () {
  ...
  function startComplete() {
    ...
    while (tprop.className == "js-property" || tprop.className == "property") {
  ...
  function getCompletions(token, context) {
    ...
    function gatherCompletions(obj) {
      ...
      else if (obj instanceof Function || obj instanceof Object) forEach(funcProps, maybeAdd);
      if(obj instanceof Object)
      {
                var _porps = Object.getOwnPropertyNames(obj);
                for (var i = 0; i < _porps.length; i++) maybeAdd(_porps[i]);
    ...
    if (context) {
      ...
      if (obj.className == "js-variable" || obj.className == "variable")
        base = window[obj.string];
      else if (obj.className == "js-string" || obj.className == "string")
        base = "";
      else if (obj.className == "js-atom" || obj.className == "atom")
        base = 1;
