                ...
                <div class="page">
                    ...
                    <div id="tool3" class="panel panel-default tool">
                        ...
                        <div id="tool4Things" class="things">
                            ...
                            <br><br>
                            <!-- Número de Apoio -->
                            <span style="color:  #333333; font-size: 11px;">Número de Apoio:</span>
                            <input id="objEventosApoio" type="text" value="0" class="form-control" style="height: 25px; padding: 5px;" placeholder="0" >  
                            <br><br>
                            <!-- Botão de script -->
