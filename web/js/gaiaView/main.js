...
$(document).ready(function ()
{
    ...
    modelObjects.add(new Item("Texto", function () {
        return new GText(153, 52, 0, 0, true);
    }, "../img/ui_labels.png")); //0
    modelObjects.add(new Item("Container", function () {
        return new GDiv(153, 52, 0, 0, true);
    }, "../img/div.png")); //1
    modelObjects.add(new Item("Container Dinamico", function () {
        return new GDivStatic(153, 52, 0, 0, true);
    }, "../img/div.png")); //2
    modelObjects.add(new Item("Container Repetidor", function () {
        return new GRepeater(153, 52, 0, 0, true);
    }, "../img/div.png")); //3
    modelObjects.add(new Item("Lista", function () {
        return new GList(153, 183, 0, 0, true);
    }, "../img/ui_list_box_blue.png")); //4
    modelObjects.add(new Item("ComboBox", function () {
        return new GComboBox(190, 40, 0, 0, true);
    }, "../img/ui_combo_box_blue.png")); //5
    modelObjects.add(new Item("Tabela", function () {
        return new GTable(190, 190, 0, 0, true);
    }, "../img/ui_scroll_pane_table.png")); //6
    modelObjects.add(new Item("Gráfico", function () {
        return new GGraph(190, 190, 0, 0, true);
    }, "../img/chart.png")); //7
    modelObjects.add(new Item("Imagem", function () {
        return new GImage(64, 64, 0, 0, true);
    }, "../img/img.png")); //8
    modelObjects.add(new Item("Botão", function () {
        return new GButton(67, 28, 0, 0, true);
    }, "../img/button.png")); //9
    modelObjects.add(new Item("Input", function () {
        return new GInput(153, 52, 0, 0, true);
    }, "../img/input.png")); //10
    modelObjects.add(new Item("Botão Upload", function () {
        return new GUpload(67, 28, 0, 0, true);
    }, "../img/button.png")); //11
    modelObjects.add(new Item("CheckBox", function () {
        return new GCheckBox(153, 52, 0, 0, true);
    }, "../img/input.png")); //12
    modelObjects.add(new Item("Text Area", function () {
        return new GTextArea(153, 153, 0, 0, true);
    }, "../img/ui_scroll_pane_both.png")); //13
    modelObjects.add(new Item("Text Editor", function () {
        return new GTextEditor(300, 153, 0, 0, true);
    }, "../img/ui_scroll_pane_both.png")); //14
    modelObjects.add(new Item("Auto Form", function () {
        return new GForm(300, 153, 0, 0, true);
    }, "../img/list.png")); //15
    modelObjects.add(new Item("Audio", function () {
        return new GAudio(200, 35, 0, 0, true);
    }, "../img/ui-audio.png")); //16
    modelObjects.add(new Item("HAudio", function () {
        return new GAudioHide(16, 16, -20, -20, true);
    }, "../img/ui-audio.png")); //17
    modelObjects.add(new Item("FonteDados", function () {
        return new FonteDados(1, 1, -20, -20, true);
    }, "../img/db_blank16.png")); //18
    ...
    window.onresize = function ()
    {
        ...
        $("#windowElementos").css("left", document.documentElement.clientWidth - 225 - 290);
        
        // center to complete
        $("#windowCompleted").css("left", (document.documentElement.clientWidth - 280 - 220) / 2);
        
        // center to debug
        $("#windowDebug").css("left", (document.documentElement.clientWidth - 280 - 220) / 2);
