  ...
  */
  ...
  KineticScroll = (function() {
    ...
    KineticScroll.prototype.finishScroll = function(xOrY) {
	  ...
	  if(this.content.style.webkitTransform != undefined)
	  	this.content.style.webkitTransform = "translate(" + this.offsetX + "px," + this.offsetY + "px)";
	  else if(this.content.style.MozTransform != undefined)
		this.content.style.MozTransform = "translate(" + this.offsetX + "px," + this.offsetY + "px)";
	  else if(this.content.style.msTransform != undefined)
		this.content.style.msTransform = "translate(" + this.offsetX + "px," + this.offsetY + "px)";
